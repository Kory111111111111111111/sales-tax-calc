    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 py-6 relative z-10 flex-grow">
          {/* Warning Banner */}
          {showWarningBanner && (
            <div className="mb-6 bg-red-950/80 border border-red-500/50 text-white px-4 py-3 rounded-lg shadow-lg relative backdrop-blur-md animate-fade-in text-center" style={{ verticalAlign: 'top' }}>
              <button
